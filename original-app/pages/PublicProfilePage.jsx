...
const PublicProfilePage = ({ profileId }) => {
  ...
  if (isLoading) {
    return (
      <div className="text-center p-10 text-xl text-purple-300">
        Loading profile...
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="md:col-span-2">
            <Card
              ...
              icon={<FaLock size={20} />}
              isVisible={visibility.currentStatus}
            >
          ...
          <div>
            <Card
              title="Arousal History"
              icon={<FaChartLine size={20} />}
              isVisible={visibility.arousalChart}
            >
          ...
          <div className="md:col-span-2">
            <Card
              title="Chastity History"
              icon={<FaBook size={20} />}
              isVisible={visibility.chastityHistory}
            >
          ...
          <div className="md:col-span-2">
            <Card
              title="Sexual Events Log"
              icon={<FaListAlt size={20} />}
              isVisible={visibility.sexualEvents}
            >
              <EventLogTable
