      ...
      case "error":
        return (
          <div className="text-center text-gray-50">
            ...
            <p className="text-sm text-yellow-400 font-semibold mb-6 bg-red-900/50 p-3 rounded-md">
              {resetError}
            </p>
            <button
              type="button"
        ...
        return (
          <>
            ...
            <p className="text-sm text-yellow-400 font-semibold mb-6">
              This action will PERMANENTLY DELETE all of your ChastityOS data,
              including history, events, and settings. This cannot be undone.
            </p>
