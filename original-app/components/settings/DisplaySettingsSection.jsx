  ...
  return (
    <div className="mb-8 p-4 bg-gray-800 border border-blue-700 rounded-lg shadow-sm">
      ...
      <div className="flex items-center justify-between">
        <label
          htmlFor="eventDisplayModeToggle"
          className="text-sm font-medium text-purple-300 mr-3"
        >
          Event Display Mode:
        </label>
      ...
      <p className="text-xs text-gray-400 mt-2 text-left">
        Choose 'Kinky' to see all logged sexual events. Choose 'Vanilla' to hide
        specific "kinky" event types from the log for a more discreet view.
      </p>
    </div>
  );
};
