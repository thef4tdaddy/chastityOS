  ...
  return (
    <>
      <div className="tasks-container">
        <h4 className="text-lg font-semibold mb-3 pb-2 border-b border-blue-800">
          Assign a New Task
        </h4>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-2">
              ...
              {punishmentType === "time" && (
                <input
                  ...
                  onChange={(e) => setPunishmentValue(e.target.value)}
                  placeholder="Hours"
                  className="w-full sm:w-24"
                />
              )}
              {punishmentType === "note" && (
                <input
                  ...
                  value={punishmentValue}
                  onChange={(e) => setPunishmentValue(e.target.value)}
                  placeholder="Describe punishment..."
                  className="flex-grow"
                />
              )}
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 z-50 flex items-center justify-center p-4">
          <div className="bg-gray-800 border-2 border-red-500 rounded-lg shadow-2xl p-6 w-full max-w-md text-center">
            ...
            <p className="text-gray-300 mb-6">
              Cannot set a deadline in the past. Please choose a future date and
              time.
            </p>
            <button
