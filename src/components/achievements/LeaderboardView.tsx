    ...
    return (
      <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 text-center">
        ...
        <div className="flex gap-4 justify-center">
          ...
          <button
            onClick={() => setIsOptedIn(true)} // Skip opt-in for now
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
        <div className="flex flex-wrap gap-4 items-center">
          <div>
            <label className="block text-sm text-nightly-celadon mb-1">Category</label>
            <select
            ...
            >
              ...
              <option value={LeaderboardCategory.ACHIEVEMENTS_EARNED}>Achievements Earned</option>
              <option value={LeaderboardCategory.LONGEST_STREAK}>Longest Streak</option>
              <option value={LeaderboardCategory.SESSION_COUNT}>Session Count</option>
              <option value={LeaderboardCategory.TOTAL_TIME}>Total Time</option>
            </select>
          </div>
          
          <div>
            <label className="block text-sm text-nightly-celadon mb-1">Period</label>
            <select
          ...
          {leaderboardData.map((entry, index) => (
            <div
              ...
              className={`p-4 flex items-center justify-between hover:bg-white/5 transition-colors ${
                entry.isCurrentUser ? 'bg-blue-900/20 border-l-4 border-blue-400' : ''
              }`}
            >
