    ...
    return (
      <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 text-center">
        ...
        <p className="text-nightly-celadon mb-6 max-w-md mx-auto">
          Compete with other users and see how your achievement progress stacks
          up. Your participation is completely optional and anonymous.
        </p>
        ...
        <div className="flex flex-wrap gap-4 items-center">
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setSelectedCategory(e.target.value as LeaderboardCategory)
              }
            ...
            >
              <option value={LeaderboardCategory.TOTAL_POINTS}>
                Total Points
              </option>
