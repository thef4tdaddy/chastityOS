 ...
 * Error boundary specifically for achievement components
 * Provides graceful error handling for achievement-related failures
 */
...
export class AchievementErrorBoundary extends React.Component<
  Props,
  ErrorState
> {
  ...
  render(): React.ReactNode {
    if (this.state.hasError) {
      ...
      // Default fallback using AchievementError component
      return (
        <AchievementError
          error={this.state.error}
