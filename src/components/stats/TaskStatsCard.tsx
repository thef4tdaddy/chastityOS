    ...
    <div className="p-4 bg-gray-900/50 border-2 border-primary rounded-2xl shadow-lg shadow-primary/20">
      ...
      <div className="space-y-3">
        ...
        <div className="flex justify-between items-center p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
          <span className="text-gray-300 font-medium">Tasks Completed</span>
        ...
        <div className="flex justify-between items-center p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg">
          <span className="text-gray-300 font-medium">Approval Rate</span>
      ...
      <div className="mt-4 pt-4 border-t border-gray-700/50">
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <p className="text-red-400 font-semibold">{stats.tasksRejected}</p>
          </div>
        </div>
      </div>
    </div>
