...
export const MobileInput = forwardRef<HTMLInputElement, MobileInputProps>(({
  ...
  const variantClasses = {
    default: 'border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800',
    filled: 'border-0 bg-gray-100 dark:bg-gray-700',
    borderless: 'border-0 bg-transparent border-b-2 border-gray-300 dark:border-gray-600 rounded-none'
  };
  ...
  const mobileInputProps = {
    ...
    inputMode: type === 'email' ? 'email' as const :
               type === 'tel' ? 'tel' as const :
               type === 'number' ? 'numeric' as const :
