...
export const KeyholderRequirement: React.FC<KeyholderRequirementProps> = ({
  keyholderName,
  ...
  return (
    ...
    >
      <p className={`text-sm font-semibold text-purple-200`}>
        {keyholderName} requires {savedSubmissivesName || "the submissive"} to
        be in chastity for {requiredKeyholderDurationSeconds}
      </p>
    </div>
  );
};
