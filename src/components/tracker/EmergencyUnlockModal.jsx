  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div className="relative bg-gray-800 p-6 md:p-8 rounded-xl shadow-lg w-full max-w-md border border-red-700">
        ...
        <h3 className="text-lg md:text-xl font-bold mb-4 text-red-400 text-center">
          Emergency Unlock
        </h3>
        ...
        {isSuccessful ? (
          ...
          <>
            <p className="text-sm text-purple-200 mb-4 text-center">
              A Hardcore Goal is active. To unlock early, please provide your
              6-character backup code.
            </p>
            <input
              type="text"
              value={backupCode}
