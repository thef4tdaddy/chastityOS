      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          ...
          <p className="text-blue-800 text-sm">
            ...
            participants. You can end relationships at any time, and your data
        ...
        {needsMigration && (
          <div className="mt-6 p-4 bg-yellow-50 rounded-lg">
            ...
            <p className="text-yellow-800 text-sm">
              We've detected existing chastity data. Use the migration feature
              above to convert your data to the new relationship system. This
              creates a self-managed profile that you can later share with a
              keyholder.
            </p>
          </div>
        )}
