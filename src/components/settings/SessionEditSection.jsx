...
const SessionEditSection = ({
  ...
  if (!isCageOn) {
    return (
      <div className="mb-8 px-4 py-5 sm:p-6 bg-orange-950 border border-orange-700 rounded-lg shadow">
        <h3 className="text-lg leading-6 font-medium text-orange-200 mb-3">
          Edit Chastity Start Time
        </h3>
  ...
  return (
    <div className="mb-8 px-4 py-5 sm:p-6 bg-orange-950 border border-orange-700 rounded-lg shadow">
      ...
      <p className="text-sm text-orange-300 mb-4">
        Adjust the date and time when the current chastity session started. This
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
        <div>
          <label
            ...
            className="block text-sm font-medium text-orange-300 mb-1"
          >
            New Start Date:
          </label>
          <input
      ...
      <button
        ...
        disabled={
          !isAuthReady || !editSessionDateInput || !editSessionTimeInput
        }
      ...
      {editSessionMessage && (
        <p
          className={`text-xs mt-2 ${editSessionMessage.includes("success") ? "text-green-400" : "text-red-400"}`}
        >
          {editSessionMessage}
        </p>
      )}
