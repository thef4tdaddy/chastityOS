 ...
 *
 * Handles initialization and loading of pause system state including
 * keyholder overrides, cooldown state, and pause analytics.
 */
...
interface UsePauseInitializationProps {
  sessionId: string;
...
export const usePauseInitialization = ({
  sessionId,
  relationshipId,
  pauseHistory,
  startCooldown,
}: UsePauseInitializationProps) => {
