/**
 * Gamification Data Hook
 * Handles loading of gamification-related data including player profile,
 * challenges, leaderboards, season, social features, and experience history
 */
...
export const useGameificationData = (userId: string) => {
  // Get player profile
