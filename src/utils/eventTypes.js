...
export const eventTypes = {
  ...
  PERSONAL_GOAL_COMPLETED: { type: 'PERSONAL_GOAL_COMPLETED', text: 'Personal Goal Completed' },
  PERSONAL_GOAL_REMOVED: { type: 'PERSONAL_GOAL_REMOVED', text: 'Personal Goal Removed' },
  ...
  // Keyholder Events
  KEYHOLDER_SESSION_LOCKED: { type: 'KEYHOLDER_SESSION_LOCKED', text: 'Session Locked by Keyholder' },
  KEYHOLDER_SESSION_UNLOCKED: { type: 'KEYHOLDER_SESSION_UNLOCKED', text: 'Session Unlocked by Keyholder' },
  KEYHOLDER_TASK_APPROVED: { type: 'KEYHOLDER_TASK_APPROVED', text: 'Task Approved by Keyholder' },
  KEYHOLDER_TASK_REJECTED: { type: 'KEYHOLDER_TASK_REJECTED', text: 'Task Rejected by Keyholder' },
};
