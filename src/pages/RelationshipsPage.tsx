      ...
      <div className="container mx-auto py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Manage your connections with keyholders and submissives. Create relationships 
            to share chastity tracking, tasks, and oversight.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mt-12 p-6">
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 text-sm text-gray-600">
              <div>
                <h3 className="font-medium text-gray-900 mb-2">For Submissives:</h3>
              ...
              <div>
                <h3 className="font-medium text-gray-900 mb-2">For Keyholders:</h3>
                <ul className="space-y-1">
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-blue-800 text-sm">
                All relationship data is encrypted and only visible to the participants. 
                You can end relationships at any time, and your data remains under your control.
              </p>
            </div>

            {needsMigration && (
              <div className="mt-6 p-4 bg-yellow-50 rounded-lg">
                <h3 className="font-medium text-yellow-900 mb-2">Data Migration</h3>
                <p className="text-yellow-800 text-sm">
                  We've detected existing chastity data. Use the migration feature above to 
                  convert your data to the new relationship system. This creates a self-managed 
