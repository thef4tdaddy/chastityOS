  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'liquid-glass': 'linear-gradient(45deg, rgba(147, 197, 253, 0.1), rgba(196, 181, 253, 0.1), rgba(251, 146, 60, 0.1))',
      },
      backdropBlur: {
        xs: '2px',
        'sm': '4px',
      ...
      boxShadow: {
        ...
        'liquid': '0 8px 32px rgba(147, 197, 253, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.1)',
      },
      animation: {
