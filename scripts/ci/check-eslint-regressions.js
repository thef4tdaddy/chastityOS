...
console.log(
  `ESLint check complete. Found ${errorCount} errors and ${warningCount} warnings.`,
);
...
if (errorCount > MAX_ERRORS || warningCount > MAX_WARNINGS) {
  console.error(
    `Regression detected! Errors: ${errorCount} (max ${MAX_ERRORS}), Warnings: ${warningCount} (max ${MAX_WARNINGS}).`,
  );
